...
# %%
# Get unique pairs and reverse pairs
...
# Now, get all unique pairs and reverse pairs (e.g. 1,5 is same as 5,1)
...
def get_jfile(mu, std, unique_pairs):
    ...
    repeated_J = []
    for reverse_pair in reverse_pairs:
        if reverse_pair[::-1] in unique_pairs:
            # get corresponding coupling index
            coupling_index = unique_pairs.index(reverse_pair[::-1])
    ...
    all_pairs = unique_pairs + reverse_pairs
